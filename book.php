...
$db_name = 'mysql:host=localhost;dbname=menzabetha';
$db_user_name = 'root';
$db_user_pass = '';
...
if(isset($_POST['send'])){
   ...
   $insert_book = $conn->prepare("INSERT INTO `book_db`(id, name, email, phone, address, location, guests, arrivals, leaving) VALUES(?,?,?,?,?,?,?,?,?)");
